...
def test_bishop_valid_move():
    ...
    assert (
        bishop_move(Position(3, 3), Position(5, 5), TeamType.OUR, board.pieces) == True
    )
...
def test_bishop_blocked_move():
    ...
    assert (
        bishop_move(Position(3, 3), Position(5, 5), TeamType.OUR, board.pieces) == False
    )
...
def test_king_invalid_move():
    ...
    board = Board([king], 0)
    assert (
        king_move(Position(5, 1), Position(5, 3), TeamType.OUR, board.pieces) == False
    )
...
def test_knight_valid_move():
    ...
    assert (
        knight_move(Position(3, 3), Position(5, 4), TeamType.OUR, board.pieces) == True
    )
...
def test_knight_invalid_move():
    ...
    board = Board([knight], 0)
    assert (
        knight_move(Position(3, 3), Position(4, 4), TeamType.OUR, board.pieces) == False
    )
...
def test_pawn_blocked_move():
    ...
    assert (
        pawn_move(Position(1, 2), Position(1, 3), TeamType.OUR, board.pieces) == False
    )
...
def test_queen_valid_move():
    ...
    board = Board([queen], 0)
    assert (
        queen_move(Position(4, 4), Position(6, 6), TeamType.OUR, board.pieces) == True
    )
...
def test_queen_blocked_move():
    ...
    assert (
        queen_move(Position(4, 4), Position(6, 6), TeamType.OUR, board.pieces) == False
    )
...
def test_rook_blocked_move():
    ...
    assert (
        rook_move(Position(1, 1), Position(1, 8), TeamType.OUR, board.pieces) == False
    )
